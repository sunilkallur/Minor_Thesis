...
Once the Beta testing is done we will do the market launch i.e all these power detectors will be deployed in each house at the point of tracking device to check in near real time the power outage and usage.The complete process of operation needs to be optimized on field for making the system more reliable and this will be done by the end of October 2015.
