...
Similar market study and meetings were held with other developed countries in Estonia and Sweden(The names are not disclosed based on their request).The systems differ with respect to region and a custom solution for the customer was the fact. Based on the customer feedback from all these we started working on making our concept ready for business. 
