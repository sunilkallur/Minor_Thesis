...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|c|c|c|}
        \hline
        \textbf{Type}                      & \textbf{Average} & \textbf{\begin{tabular}[c]{@{}c@{}}Peak\\ (18:00 to 23:00)hours\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Shoulder\\ (05:00 to 18:00)hours\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Offpeak\\ (23:00 to 05:00)hours\end{tabular}} \\ \hline
        Domestic Consumers Charge          & \multicolumn{4}{c|}{\begin{tabular}[c]{@{}c@{}}150 : For the first 15Units in the month\\ 531.5 : For usage above 15Units\end{tabular}}                                                                                                                                 \\ \hline
        Commercial Consumers Charge        & 484.6            & 602.5                                                                         & 485.1                                                                             & 336.5                                                                            \\ \hline
        Medium industrial Consumers Charge & 461.6            & 570.1                                                                         & 461.9                                                                             & 314.5                                                                            \\ \hline
        Large industrial Consumers Charge  & 315.6            & 383.5                                                                         & 316.4                                                                             & 233.0                                                                            \\ \hline
    \end{tabular}
    \caption{My caption}
    \label{my-label}
\end{table}
