...
Similar market study and meetings were held with other developed countries in Estonia and Sweden(The names are not disclosed based on their request).The systems differ with respect to region.Based on the customer feedback, we started working on making our concept more ready for customer.

In Uganda, the working model with UMEME is either with postpaid or prepaid connection.The connection provides electricity to the household,utility buildings or for retailers.  
