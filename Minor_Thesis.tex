...
Being one of the co founder of Lumingo, i have been involved in all stages of discussion within the company.I am mainly responsible for the hardware and embedded technologies. I have designed the power detector modules to prototype it to the customers.I have also designed the Gateway module using Raspbery Pi2,FONA GPRS module and FIWARE as the cloud platform. The First prototype is ready and now i am working on making the next version of the product which will be a ready to deploy product i.e market ready. 
